...
% -----------------------------------------------------------------
% Requirements Configuration Parameters - CASE 2 Increase Modulation Type
% -----------------------------------------------------------------
% TBS size 
% 14 symbols per slot 
% slot 0 
...
scs = 30000; % SCS 30kHz
data_repeat = repmat(txdata1, nFrame, 1); 
savevsarecordingmulti('PDSCH_Waveform_1P1V_256QAM.mat', data_repeat, NFFT*scs, centerFreq, nchannel);


% -----------------------------------------------------------------
% Requirements Configuration Parameters - CASE 3 Change PDSCH Allocation
% -----------------------------------------------------------------
% TBS size 
% 14 symbols per slot 
% slot 0 
...
scs = 30000; % SCS 30kHz
data_repeat = repmat(txdata1, nFrame, 1); 
savevsarecordingmulti('PDSCH_Waveform_1P1V_HaftBandwidth.mat', data_repeat, NFFT*scs, centerFreq, nchannel);

% -----------------------------------------------------------------
% Requirements Configuration Parameters - CASE 4 Change Slot Index
% -----------------------------------------------------------------
% TBS size 
% 14 symbols per slot 
% slot 1
...
% -----------------------------------------------------------------
% Requirements Configuration Parameters - CASE 5 Change PDSCH Start Symbol
% -----------------------------------------------------------------
% TBS size 
% 14 symbols per slot 
% slot 0 
...
% -----------------------------------------------------------------
% Requirements Configuration Parameters 
% Case 7 - DMRS addtional position 1
% -----------------------------------------------------------------
% TBS size 
% 14 symbols per slot 
% slot 0 
...
% -----------------------------------------------------------------
% Requirements Configuration Parameters - CASE  8DMRS Type 2
% -----------------------------------------------------------------
% TBS size 
% 14 symbols per slot 
% slot 0 
