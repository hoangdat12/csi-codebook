...
% function [BER1, BER2] = muMIMO2UE(baseConfig, W1, W2, H1, H2, SNR_dB) 
% % This function is a pipeline for mesurement the BER of transmit MUMIMO 2 UE.
% %
% % W1 and W2 must satisfy the orthogonality threshold (chordal distance
% %     >= 0.9999) since the Tx/Rx chain does not apply ZF or MMSE interference
...
%     % AWGN Channels
%     % ------------------------------------------------------------------------
%     rxWaveform_UE1 = txWaveform * H1.';   % [nSamples x Nr]
%     rxWaveform_UE2 = txWaveform * H2.';
%     noiseVarEst    = eps;
...
%     %   -> DMRS-based LS Channel Estimation -> MMSE Equalization -> PDSCH Decoding
%     % -------------------------------------------------------------------------
%     [rxBits1, ~] = rxPDSCHDecode(carrier, pdsch1, rxWaveform_UE1, TBS1, NFFT, noiseVarEst);
%     [rxBits2, ~] = rxPDSCHDecode(carrier, pdsch2, rxWaveform_UE2, TBS2, NFFT, noiseVarEst);
