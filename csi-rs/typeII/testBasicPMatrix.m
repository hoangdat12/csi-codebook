function W = testBasicPMatrix()
    ...
    phi = computePhiRankV(i14, i21, L, NPsk);
    
    W = computePrecodingMatrix(1, L, N1, N2, O1, O2, n1, n2, q1, q2, p1_li, p2_li, phi);
end
...
function phi = computePhiRankV(i14, i21, L, NPsk)
    [v, n] = size(i14); 
    phi = ones(v, n); 
...
function W = computePrecodingMatrix(l, L, N1, N2, O1, O2, n1, n2, q1, q2, p1, p2, phi)
