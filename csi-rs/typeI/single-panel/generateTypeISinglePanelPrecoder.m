function W = generateTypeISinglePanelPrecoder(codebookMode, nLayers, N1, N2, O1, O2, i11, i12, i13, i2, nPorts)
    ...
    % Retrieve Beam Indices
    % Fetches l, m, lp, mp based on the specific mapping tables for each rank/mode
    [l, m, lp, mp, lpp, mpp, lppp, mppp, p, n] = getBeamIndices(codebookMode, nLayers, i11, i12, i13, i2, N1, N2, O1, O2);

    % Select co-phasing factor phi_n
    phi_n = phiSet(n+1);
    theta_p = exp(1j * pi * p / 4);

    % Generate Precoding Matrix W based on nLayers
    switch nLayers
        case 1
